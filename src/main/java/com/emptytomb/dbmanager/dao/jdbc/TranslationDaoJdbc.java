...
/**
 * The TranslationDaoJdbc class is a concrete JDBC implementation of the TranslationDao interface.
 * This class implements the JDBC persistence storage layer for the Translation domain model.
 * 
...
public class TranslationDaoJdbc implements TranslationDao {
  private Logger logger = LoggerFactory.getLogger(TranslationDaoJdbc.class);
  private static TranslationDaoJdbc instance = null;
  ...
  private static final String TRANSLATION_VERSION = "version";  // niv
   ...
   private TranslationDaoJdbc() {
	connection = ConnectionFactory.getInstance().getConnection();
  }
  
  /**
   * This method returns the single instance of the TranslationDaoJdbc object.
   * 
   * @return  the TranslationDaoJdbc object
   * 
   */
  public static TranslationDaoJdbc getInstance() {
      if (instance == null) {      
          synchronized (TranslationDaoJdbc.class) {
              if (instance == null) {
                  instance = new TranslationDaoJdbc(); 
              }
          }
      }
      return instance;
